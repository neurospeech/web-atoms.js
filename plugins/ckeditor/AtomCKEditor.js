...
window.CKEDITORPluginRegistered = false;

function registerCKEDITORPlugin() {

    if (window.CKEDITORPluginRegistered)
        return;

    window.CKEDITORPluginRegistered = true;
    ...
    return classCreatorEx({
        ...
        methods: {
            ...
            initialize: function () {
                ...
                var e = this._element;
                AtomUI.assignID(e);
                this.editor = CKEDITOR.appendTo(e.id, {}, this._value || '');
                var _this = this;
                this.editor.on('change', function () {
                    AtomBinder.refreshValue(_this, "value");
                });
            },
            dispose: function () {
                if (this.editor) {
