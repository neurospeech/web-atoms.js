...
function classCreator(n,m,e,t,r,C,E){var A=m?m.constructor:null,p=e||function(){};m=null;if(A){m=r?function(){for(var e in r)this["_"+e]=r[e];A.apply(this,arguments);this.__typeName=n;p.apply(this,arguments)}:function(){A.apply(this,arguments);this.__typeName=n;p.apply(this,arguments)};e=A.prototype;for(var q in e)t[q]||e.hasOwnProperty(q)&&(t[q]=e[q])}else m=r?function(){this.__typeName=n;for(var e in r)this["_"+e]=r[e];p.apply(this,arguments)}:function(){this.__typeName=n;p.apply(this,arguments)};
...
"",c=0;c<arguments.length;c++){var b=arguments[c];if(null===b||void 0===b)return;a+=b}if(/^\/\//.test(a))return r.location.protocol+a;"https:"==r.location.protocol&&(a=a.replace(/http\:\/\//,"https://"));return a},resolve:function(a,c){var b=!c;if(!a)return a;b&&(c=new u,c.list=[],c.done=function(b){q.remove(c.list,b);0==c.list.length&&c.pushValue(a)});if("object"==typeof a)if("undefined"!=typeof a.length)for(var f=0;f<a.length;f++){var k=a[f];if(k){var h=a,g=f;k instanceof u||k.constructor==u?(c.list.push(k),
k.failed(function(b){c.done(b)}),k.then(function(b){h[g]=b.value();c.done(b)})):q.resolve(k,c)}}else for(f in a)if(k=a[f])k instanceof u||k.constructor==u?(c.list.push(k),k.failed(function(b){c.done(b)}),h=a,g=f,k.then(function(b){h[g]=b.value();c.done(b)})):q.resolve(k,c);if(c.list.length){if(b)c.onInvoke(function(){for(var b=new p(c.list);b.next();)b.current().invoke(c._invoker)});return c}return a}};m.Atom=q;(function(){for(var a,c=/\+/g,b=/([^&=]+)=?([^&]*)/g,f=m.location.search.substring(1),
...
g&&(c.key=g);if(s.isNode(b))e(b).bind(a,null,w);else if(b.addEventListener)b.addEventListener(a,w,!1);else{var D=b["add_"+a];null==D?(D=d["add_"+a],g?D.apply(d,[b,g,w]):D.apply(d,[b,w])):D.apply(b,[w])}this._eventHandlers.push(c)}},unbindEvent:function(b,a,c,g){for(var w=new p(this._eventHandlers),D=[];w.next();){var x=w.current();if(!b||b===x.element)if(!a||a===x.name)if(!c||c===x.methodName)if(!g||g===x.key){if(s.isNode(x.element))e(x.element).unbind(x.name,x.handler);else if(x.element.removeEventListener)x.element.removeEventListener(a,
x.handler,!1);else{var n=x.element["remove_"+x.name];null==n?(n=d["remove_"+x.name],x.key?n.apply(d,[x.element,x.key,x.handler]):n.apply(d,[x.element,x.handler])):n.apply(x.element,[x.handler])}D.push(x)}}if(D.length==this._eventHandlers.length)this._eventHandlers.length=0;else for(w=new p(D);w.next();)x=w.current(),G.remove(this._eventHandlers,x)},init:function(){},dispose:function(){this.unbindEvent(null,null,null);this.__delegates&&(this.__delegates=null)}})})(this,"WebAtoms.AtomComponent",null);
...
if(b=c.confirm){var e="Are you sure?";b.hasOwnProperty("length")&&(1<b.length?(e=b[0],b=b[1]):b=b[0]);var g=this,d=b;q.confirm(e,function(){g.invokeAction(d,a)})}(b=c.alert)&&q.alert(b);(b=c.next)?this.invokeAction(b,a):(b=c.control)&&L[b].refresh()}}},refresh:function(){},get_element:function(){return this._element},clearBinding:function(b,a){for(var c=new p(this.bindings),g,e=[];c.next();)g=c.current(),b&&g.element!=b||a&&g.key!=a||(g.dispose(),e.push(g));for(c=new p(e);c.next();)G.remove(this.bindings,
...
b.current();a(h,b.currentIndex())&&c.push(h)}b=this._filteredItems=c}var g=this._sortPath;g&&(g.constructor==String?(c=!1,a=g.indexOf(" "),-1!=a&&(c=g.substr(a+1),g=g.substr(0,a),c=/desc/gi.test(c)),a=c?function(b,a){return a[g].localeCompare(b[g])}:function(b,a){return b[g].localeCompare(a[g])},b=b.sort(a)):b=b.sort(g));return b}return e(this._itemsPresenter).children()},getIndexOfDataItem:function(b){if(null==b)return-1;for(var a=this.get_dataItems(),a=new p(a);a.next();)if(a.current()==b)return a.currentIndex();
...
this.get_element(),c=0,h=parseInt(e(a).css("paddingTop"),10),g=this.calculateSize(),d=g.height,g=g.width;this._contentWidth&&(c=(g-this._contentWidth)/2,g=this._contentWidth);var n,m,q;for(n=new p(e(a).children("[atom-dock='Top']"));n.next();)m=n.current(),q=e(m).outerHeight(!0),b.setItemRect(m,{top:h,left:c,width:g}),h+=q,d-=q,this.resizeChild(m);for(n=new p(e(a).children("[atom-dock='Bottom']").get().reverse());n.next();)m=n.current(),q=e(m).outerHeight(!0),d-=q,b.setItemRect(m,{left:c,top:h+d,
width:g}),this.resizeChild(m);for(n=new p(e(a).children("[atom-dock='Left']"));n.next();)m=n.current(),q=e(m).outerWidth(!0),g-=q,b.setItemRect(m,{top:h,left:c,height:d}),c+=q,this.resizeChild(m);for(n=new p(e(a).children("[atom-dock='Right']").get().reverse());n.next();)m=n.current(),q=e(m).outerWidth(!0),g-=q,b.setItemRect(m,{left:g+c,top:h,height:d}),this.resizeChild(m);for(n=new p(e(a).children("[atom-dock='Fill']"));n.next();){m=n.current();if(q=e(m).css("max-width"))q=parseFloat(q),0<q&&(g=
...
r.title,location.href.split("#")[0]+d):location.href=d,this._noHashRefresh=!1)):history&&history.pushState?history.pushState({},r.title,location.href.split("#")[0]):location.hash=""}}},onInitialized:function(){var a={},c=this._scope,h;for(h in c)if(0!=h.indexOf("_")){var g=c[h];if(void 0!==g&&null!==g){var e=typeof g;if("string"==e||"number"==e||"boolean"==e)a[h]=g}}this._defaultScopeValues=a;if(a=q.encodeParameters(this._scope))this._defaultScope="#"+a;b.onInitialized.call(this)},createChildren:function(){b.createChildren.call(this);
...
/^\$\[/gi.test(h)&&(h=h.substr(2),/^\$/gi.test(h)||(h="$"+h),h="["+h,f=h.indexOf("]"),h=h.substr(0,f+1),e(k).attr("atom-field-value",h));return s.createControl(k,n.AtomFieldType)},createChildren:function(){var a=this._element;e(a).addClass("atom-form");var b=new p(e(a).children()),f=r.createElement("TABLE");e(f).addClass("atom-form-table");var k=r.createElement("TBODY");s.removeAllChildren(a);a.appendChild(f);f.appendChild(k);for(this.getTemplate("fieldTemplate");b.next();)(a=b.current())&&this.createField(k,
...
properties:{url:"",layout:null,items:[],removeOnBack:!0},methods:{set_url:function(b){if(b){var a=b.indexOf("?"),c=b,h="";-1!==a&&(c=b.substr(0,a),h=b.substr(a+1));var a=this._items,g=q.query(a).firstOrDefault({url:c});if(!g){var d=q.get(this,"scope")[c];if(!d){console&&console.error&&console.error("Page Template "+d+" not found");return}d=s.cloneNode(d);g={url:c,index:a.length,element:d};q.add(a,g);this._element.appendChild(d);var m=s.createControl(d,e(d).attr("atom-type")||n.AtomControl);g.control=
m;n.dispatcher.callLater(function(){m.init()})}q.set(this,"selectedIndex",g.index);h&&n.dispatcher.callLater(function(){location.hash=h});this._url=b}},onBackCommand:function(){var b=this._selectedIndex;if(b){var a=q.query(this._items).firstOrDefault({index:b});if(a){var c=this,b=b-1;q.set(this,"selectedIndex",b);c._removeOnBack&&setTimeout(function(){a.control.dispose();e(a.element).remove();q.remove(c._items,a);for(var h=q.query(c._items),g=0;h.next();){var d=h.current();d.index=g++;h.currentIndex()==
b&&(c._url=d.url,q.refresh(c,"url"))}},1E3)}}},init:function(){c.init.call(this);var b=this,a=this._url;a&&n.dispatcher.callLater(function(){b.set_url(a)})}}})})(m,n.AtomViewStack.prototype);(function(a,c){return classCreatorEx({name:"WebAtoms.AtomLinkBar",base:c,start:function(){this._allowSelectFirst=!1;var b=this;this.openMenuCommand=function(){b.openMenu.apply(b,arguments)}},properties:{itemsPath:"items",selectCurrent:!0,targetPath:"",menuTemplate:null,menuDirection:"horizontal"},methods:{onClick:function(){},
...
F.defaultInstance=new F;q.confirm=function(a,c){var b={Message:a,ConfirmValue:!1,Confirm:c?!0:!1},d=r.createElement("DIV");r.body.appendChild(d);var k=s.createControl(d,n.AtomWindow,b);k.set_windowWidth(380);k.set_windowHeight(120);k.set_windowTemplate(k.getTemplate("alertTemplate"));k.set_title(c?"Message":"Confirm");k.set_next(function(){k.dispose();e(d).remove();b.ConfirmValue&&c&&c()});k.refresh()};q.alert=m.__chromeCSP?function(a){q.confirm(a,null)}:function(a){alert(a)};e(m.document).ready(function(){n.dispatcher.setupControls();
