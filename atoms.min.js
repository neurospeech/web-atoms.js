...
function classCreator(n,m,f,t,s,C,E){var z=m?m.constructor:null,p=f||function(){};m=null;if(z){m=s?function(){for(var f in s)this["_"+f]=s[f];z.apply(this,arguments);this.__typeName=n;p.apply(this,arguments)}:function(){z.apply(this,arguments);this.__typeName=n;p.apply(this,arguments)};f=z.prototype;for(var q in f)t[q]||f.hasOwnProperty(q)&&(t[q]=f[q])}else m=s?function(){this.__typeName=n;for(var f in s)this["_"+f]=s[f];p.apply(this,arguments)}:function(){this.__typeName=n;p.apply(this,arguments)};
if(s)for(q in s)t["get_"+q]||(t["get_"+q]=createProperty("_"+q,!0)),t["set_"+q]||(t["set_"+q]=createProperty("_"+q));m.__typeName=n;z&&(m.__baseType=z);m.prototype=t;m.prototype.constructor=m;t.hasOwnProperty("toString")||(m.prototype.toString=function(){return n});mapLibrary(/\./.test(n)?n:"WebAtoms."+n,window,m);return m}function classCreatorEx(n){return classCreator(n.name,n.base,n.start,n.methods,n.properties)}var createClass=classCreatorEx,WebAtoms={};
...
/mac os x/gi.test(this.userAgent)&&!/iphone|ipad/gi.test(this.userAgent);switch(this.browserName){case "Firefox":this.supportsUpload=4<=this.majorVersion;this.isFF=!0;break;case "Chrome":this.supportsUpload=6<=this.majorVersion;this.isChrome=!0;break;case "Microsoft Internet Explorer":this.supportsUpload=10<=this.majorVersion;this.isIE=!0;break;case "Safari":this.isSafari=!0,this.isMobile||(this.supportsUpload=5<=this.majorVersion)}this.supportsFlash=!this.isMobile}};m.AtomBrowser=z;z.detect();z.init();
...
(this._element.appendChild(this._busyTemplate),this.onCreateChildren(this._busyTemplate))},onCreated:function(){b.onCreated.call(this);if(z.isIE&&8>z.majorVersion){var c=this;setInterval(function(){c.onCheckHash()},1E3);this._lastHash=location.hash}else this.bindEvent(a,a.onhashchange?"onhashchange":"hashchange","onHashChanged");this._next&&n.dispatcher.callLater(function(){a.atomApplication.invokeAction(a.atomApplication._next)})},onCheckHash:function(){this._lastHash!=location.hash&&(this.onHashChanged(),
...
base:c,start:function(b){this._presenters=["calendarPresenter","itemsPresenter"];f(b).addClass("atom-date-field")},properties:{isOpen:!1},methods:{get_offsetLeft:function(){return f(this._element).offset().left},get_offsetTop:function(){return f(this._element).offset().top},onPopupRemoved:function(b){d.setValue(this,"isOpen",!1)},set_isOpen:function(b){if(this._isOpen=b){this.getTemplate("popupTemplate");this.popup=r.cloneNode(this._popupTemplate);this.popup._logicalParent=this._element;this.popup._templateParent=
this;s.body.appendChild(this.popup);this.onCreateChildren(this.popup);this.setProperties(this.popup);this.initChildren(this.popup);var a=this;this._refreshInterval=setInterval(function(){d.refreshValue(a,"offsetLeft");d.refreshValue(a,"offsetTop")})}else this._refreshInterval&&clearInterval(this._refreshInterval),this.disposeChildren(this.popup),f(this.popup).remove()},dispose:function(){this.set_isOpen(!1);c.dispose.call(this)},get_isOpen:function(){return this._isOpen},get_selectedItem:function(){return this._selectedItems.length?
...
c){return createClass({name:"WebAtoms.AtomFrameView",base:c,start:function(b){var a=this;f(b).addClass("atom-frame-view");this._items=[];this._layout=n.AtomViewBoxLayout.defaultInstance;this.backCommand=function(){a.onBackCommand.apply(a,arguments)}},properties:{url:"",layout:null,items:[],removeOnBack:!0},methods:{set_url:function(b){if(b){var a=b.indexOf("?"),c=b,h="";-1!==a&&(c=b.substr(0,a),h=b.substr(a+1));b=this._items;a=q.query(b).firstOrDefault({url:c});if(!a){var g=q.get(this,"scope")[c];
if(!g){console&&console.error&&console.error("Page Template "+g+" not found");return}g=r.cloneNode(g);a={url:c,index:b.length,element:g};q.add(b,a);this._element.appendChild(g);var f=r.createControl(g,n.AtomControl);a.control=f;n.dispatcher.callLater(function(){f.init()})}q.set(this,"selectedIndex",a.index);h&&n.dispatcher.callLater(function(){location.hash=h})}},onBackCommand:function(){var b=this._selectedIndex;if(b){var a=q.query(this._items).firstOrDefault({index:b});if(a){var c=this;this._selectedIndex=
b-1;q.refresh(this,"selectedIndex");n.dispatcher.callLater(function(){if(c._removeOnBack){a.control.dispose();f(a.element).remove();q.remove(c._items,a);for(var b=q.query(c._items),g=0;b.next();)b.current().index=g++}c.updateUI()})}}},init:function(){c.init.call(this);var b=this,a=this._url;a&&n.dispatcher.callLater(function(){b.set_url(a)})}}})})(m,n.AtomViewStack.prototype);(function(a,c){return classCreatorEx({name:"WebAtoms.AtomLinkBar",base:c,start:function(){this._allowSelectFirst=!1;var b=
this;this.openMenuCommand=function(){b.openMenu.apply(b,arguments)}},properties:{itemsPath:"items",selectCurrent:!0,targetPath:"",menuTemplate:null,menuDirection:"horizontal"},methods:{onClick:function(){},openMenu:function(b){var a=this.get_atomParent(b.target);if(null!=a){var c=a.get_data();if(c[this._itemsPath]){var h=this._subMenu;if(h)I.hide(h._element);else{var g=this.getTemplate("menuTemplate"),h=r.cloneNode(g);h._templateParent=this;h.style.position="absolute";s.body.appendChild(h);g=f(h).attr("atom-type")||
n.AtomControl;this._subMenu=h=r.createControl(h,g,c)}d.setValue(h,"data",c);I.show(a._element,h._element,0);r.cancelEvent(b)}}},selectDefault:function(){this._items&&this._selectCurrent&&!this._value&&(d.setValue(this,"value",location.pathname),-1==this.get_selectedIndex()&&this.selectItem(this._items),this.updateSelectionBindings())},selectItem:function(b,a){for(var c=new p(b),h=this._valuePath,g=location.pathname.toLowerCase();c.next();){var f=c.current(),m=f;h&&(m=m[h]);if(m){if(g==m.toLowerCase())return a||
...
g="_detail"):(a=this._newView,h=this._newHeaderToolbar,b=this.getTemplate("newHeaderTemplate"),g="_new");h&&b&&(b=r.cloneNode(b),this.addTemplate(h,b,!0),this[g+"HeaderPresenter"]=b);a&&c&&(c=r.cloneNode(c),this.addTemplate(a,c,!0),this[g+"Presenter"]=c)}},createChildren:function(){c.createChildren.call(this);this.getTemplate("gridTemplate");this.getTemplate("detailTemplate");this.getTemplate("searchTemplate");this.getTemplate("detailHeaderTemplate");this.getTemplate("newHeaderTemplate");this.getTemplate("headerTemplate");
this.getTemplate("footerTemplate");var b=this.get_scope();this._newView.atomControl._scope=new H(this,b);this._detailView.atomControl._scope=new H(this,b);b=r.cloneNode(this._gridTemplate);this.addTemplate(this._gridPresenter,b);f(this._detailTemplate).attr("atom-dock")||f(this._detailTemplate).attr("atom-dock","Fill");if(this._headerTemplate){var a=r.cloneNode(this._headerTemplate);a.setAttribute("atom-dock","Top");f(a).addClass("atom-navigator-list-header");a._templateParent=this;this.addTemplate(this._gridPanel,
a)}this._footerTemplate&&(b=r.cloneNode(this._footerTemplate),b.setAttribute("atom-dock","Bottom"),f(a).addClass("atom-navigator-list-footer"),this.addTemplate(this._gridPanel,b))},init:function(){c.init.call(this);var b=this;this.backCommand=function(){b.onBackCommand.apply(b,arguments)};this.addCommand=function(){b.onAddCommand.apply(b,arguments)};this.cancelAddCommand=function(){b.onCancelAddNewCommand.apply(b,arguments)};this.showDetailCommand=function(){b.get_selectedItem()&&(d.setValue(b,"displayMode",
...
void 0!==this._startNumber&&void 0!==this._endNumber){var a=b.toNumber(this._startNumber),c=b.toNumber(this._endNumber),h=b.toNumber(this._step),g=[];for(this._showPrompt&&g.push({label:"Select",value:0});a<=c;a+=h)g.push({label:a,value:a});this.set_items(g)}}}})})(m,n.AtomComboBox.prototype);(function(a,c){var b=a.document,e=a.$;return classCreatorEx({name:"WebAtoms.AtomPhoneControl",base:c,start:function(){this._value=""},properties:{},methods:{set_value:function(b){this._value=b;this._countries&&
...
"change","onCountryChange");this.bindEvent(this.num,"change","onDataChange");this.bindEvent(this.num,"keyup","onKeyUpLater");this.bindEvent(this.num,"keypress","onKeyUpLater");this.bindEvent(this.ext,"change","onDataChange");this.bindEvent(this.msg,"change","onDataChange");e(this._element).addClass("atom-phone-control");e(this.num).addClass("atom-pc-num");e(this.msg).addClass("atom-pc-msg");e(this.cs).addClass("atom-pc-cs");e(this.ext).addClass("atom-pc-ext");var g=this;u.cachedJson("/config/phonecountries").then(function(b){g.setCountries(b.value())}).invoke();
...
!0)};for(var a=this._viewPresenter,k=0,h=new y(this._viewTemplate);h.next();){k++;var g=h.current();a.appendChild(g);var m=f(g).attr("atom-type");m||(m="AtomViewBox",f(g).attr("atom-type",m));m=f(g).attr("atom-type")||n.AtomControl;r.createControl(g,m).init()}d.setValue(this,"steps",k);k&&d.setValue(this,"currentStep",0);this.nextCommand=function(c,d,f){var g=a.atomControl.get_selectedChild().atomControl;g._next?g.invokeAction(g._next):b.goNextCommand(c,d,f)}}}})})(m,n.AtomDockPanel.prototype);(function(a){return classCreatorEx({name:"WebAtoms.AtomYesNoControl",
...
b;d.setValue(this,"hasValue",b?!0:!1);this._onUIChanged||f(this._input).val(b)},onValueChange:function(){this._onUIChanged=!0;var b=f(this._input).val();d.setValue(this,"value",b);this._onUIChanged=!1},onUpdateUI:function(){f(this._input).addClass("atom-yes-no-custom-input");this._placeholder&&(f(this._input).attr(this._placeholder),placeHolderFixer.refresh())},init:function(){c.init.call(this);this._yesNo=this._yesNo.atomControl;this.bindEvent(this._input,"change","onValueChange")}}})})(m,n.AtomControl.prototype);
